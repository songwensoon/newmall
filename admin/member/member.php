...
class Member extends IController
{
	...
	function member_detail()
	{
		...
		$this->redirect('member_detail');
	}
	//[权限管理][管理员]检查email唯一性
	function check_email()
	{
		//php校验$name!=null , ajax校验 $name == null
		$email = ($name==null) ? IReq::get('email','post') : $name;
		$user_id   = ($id==null)   ? IReq::get('user_id','post')   : $id;
	...
	function member_save()
	{
		...
		$idcard     = IFilter::act(IReq::get('idcard'));
